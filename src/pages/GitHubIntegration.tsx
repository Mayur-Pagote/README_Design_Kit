...
export default function GitHubIntegration() {
  ...
  const restoreVersion = async (sha: string) => {
    ...
    try {
      ...
      setReadmeContent(atob(data.content.replace(/\n/g, "")));
      toast.success("Version restored to editor — save to apply changes");
    } catch {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="container mx-auto max-w-5xl">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg max-w-2xl">
              Sync your README directly with GitHub — load, edit, push, open PRs,
              track history, and manage Gists — all in one place.
            </p>
            <div className="flex flex-wrap gap-2 mt-1">
              {["Direct Sync", "PR Workflow", "Version History", "Gist Support", "Multi-file"].map((tag) => (
      ...
      <div className="container mx-auto max-w-5xl px-6 pb-20 space-y-8">
          ...
          {isAuthed && selectedRepo && activeTab === "history" && (
            ...
            >
              ...
              {versions.length === 0 && !versionsLoading && (
                <p className="text-sm text-muted-foreground">
                  Click "Load History" to see README commit history.
                </p>
              )}
