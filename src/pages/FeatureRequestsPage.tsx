...
const FeatureRequestsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-purple-50 dark:from-background dark:via-background dark:to-background">
      {/* Header */}
      <div className="bg-gradient-to-r from-purple-500 to-purple-600 text-white text-center py-16 dark:from-purple-700 dark:to-purple-800">
      ...
      {/* Controls */}
      <div className="max-w-7xl mx-auto p-6 bg-white dark:bg-card shadow-md rounded-lg mt-8">
        <div className="flex flex-wrap gap-4">
          <input
            ...
            className="flex-grow p-3 border rounded-md focus:ring-purple-500 dark:bg-background dark:text-foreground dark:border-border"
          />

          <select
            value={sortBy}
            onChange={(e) => setSortBy(e.target.value as SortOption)}
            className="p-3 border rounded-md focus:ring-purple-500 bg-white dark:bg-background dark:text-foreground dark:border-border"
          >
          ...
          <button
            ...
            className="p-3 bg-purple-600 text-white rounded-md hover:bg-purple-700 disabled:opacity-60"
            disabled={showForm}
          >
            Submit Request
          </button>
      ...
      <div className="max-w-7xl mx-auto mt-8">
        {filteredAndSortedFeatures.length === 0 ? (
          <div className="text-center py-16">
            <Filter size={48} className="mx-auto text-gray-400 dark:text-grey-600" />
            <h3 className="text-xl font-semibold text-gray-600 dark:text-gray-300 mt-4">No feature requests found</h3>
